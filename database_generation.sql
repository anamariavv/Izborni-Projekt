...
CREATE TABLE IF NOT EXISTS `token` (
  ...
  `token_status` varchar(32) NOT NULL DEFAULT 'valid',
...
--
ALTER TABLE `admin`
  ADD CONSTRAINT `admin_ibfk_1` FOREIGN KEY (`user_level_id`) REFERENCES `user_level` (`id`);
...
--
ALTER TABLE `rating`
  ADD CONSTRAINT `rating_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`);
