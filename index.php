    ...
    if($_SESSION != null) {
        echo "<table>
            ...
            foreach($result_array as $row) {
                echo "<tr><td>".$row['id']."</td><td>".$row['position']."</td><td>".$row['name']."</td><td>".$row['city']."</td><td>".$row['deadline']."</td><td><a href='internship_".$row['id'].".php'><button type='button'>View</button></a></td></tr>";
            }
        echo "</table>";
    }
